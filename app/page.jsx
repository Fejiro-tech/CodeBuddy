...
export default function LandingPage() {
  return (
    <main className="min-h-screen text-white bg-[#0A0A0A]">
      ...
      <section className="relative h-screen bg-[url('/hero3.webp')] bg-cover bg-center bg-no-repeat">
      ...
      <section id="features" className="max-w-6xl mx-auto px-8 py-24">
        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3 ">
          ...
          <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-xl py-12 px-6 text-center hover:scale-105 transition">
      ...
      <section className="bg-[#111111] py-24">
        <div className="max-w-6xl mx-auto text-center px-8">
          ...
          <Link href="/chatPage">
            <button className="bg-[#55D627] hover:bg-[#49c11f] text-black font-semibold px-4 md:px-10 py-3 md:py-4 rounded-lg shadow-lg transition text-sm md:text-base">
              Start Chatting
            </button>
          </Link>
